	  <div class="container" style="margin-top:50px;min-height: 600px;">
			...
			<ol class="breadcrumb breadcrumb-fill2">
				...
				<li class="active">أضف نشاط اقتصادي جديد</li>
			</ol>
 					  ...
 					  <div class="panel">
							...
							<form enctype="multipart/form-data" class="form-horizontal form-validation"  method="POST"  action="<?php echo base_url()?>activities/add">	
									...
									<div class="tab-pane active" id="general">
										<fieldset class="content-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<input type="text" name="data[activity_name]" class="form-control" required placeholder="أدخل اسم النشاط الإقتصادي" value="">
												</div>
											</div>										
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<textarea name="data[activity_description]" id="activity_description" rows="5"  class="form-control" placeholder="أدخل شرح عن النشاط الإقتصادي" ></textarea>
												</div>
											</div>	
